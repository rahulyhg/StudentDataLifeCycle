...
public class FirstYearList extends AppCompatActivity {
    Spinner spinner;
    private List<FirstYear> eventItemList=new ArrayList<>();
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("First Year Results");
        myRef = FirebaseDatabase.getInstance().getReference("First Year");
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists() || i==0) {
                            ...
                            for (DataSnapshot issue : dataSnapshot.getChildren()) {
                                ...
                                FirstYear details=issue.getValue(FirstYear.class);
                                eventItemList.add(details);
                            }
                            adapter=new FirstYearAdapter(FirstYearList.this,eventItemList);
                            listView.setAdapter(adapter);
                        }
                        else{
                            Toast.makeText(FirstYearList.this, "No Result Found", Toast.LENGTH_SHORT).show();
